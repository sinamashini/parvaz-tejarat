...
const HeroSection = (props) => {
  ...
  const { title, description, image } = ctaSection;
  ...
  return (
    <>
      <section className="hero__area-10">
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div className="hero__content-6 hero__six_anim">
                <Image
                  ...
                  src="/assets/imgs/icon/arrow-black.png"
                  alt="Arrow Icon"
                />
                <h1 className="hero__title-6">{title}</h1>
                <hr />
                <p>{description}</p>
              </div>
            </div>
        ...
        <Image
          ...
          src={"/assets/imgs/hero/4/hero-shape.png"}
          alt="Shape Image"
        />
        <Image
          priority
          ...
          src={"/assets/imgs/hero/4/hero-shape-2.png"}
          alt="Layout"
        />
        <Image
          priority
          ...
          src={"/assets/imgs/hero/4/hero-shape-3.png"}
          alt="Star Icon"
        />
        <Image
          priority
